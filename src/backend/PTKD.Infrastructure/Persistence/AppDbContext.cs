...
public class AppDbContext : DbContext, IOrganizationDbContext, IAuthenticationDbContext, ITokenSessionDbContext, PTKD.Application.Security.Authorization.Interfaces.IAuthorizationDbContext
{
    ...
    public DbSet<CardWatermark> CardWatermarks => Set<CardWatermark>();
    ...
    public DbSet<RelationshipKind> RelationshipKinds => Set<RelationshipKind>();
    public DbSet<KinshipComposition> KinshipCompositions => Set<KinshipComposition>();
    public DbSet<CustomerRelationship> CustomerRelationships => Set<CustomerRelationship>();
    public DbSet<GraveOwnershipHistory> GraveOwnershipHistories => Set<GraveOwnershipHistory>();
    public DbSet<GraveAttachment> GraveAttachments => Set<GraveAttachment>();
    public DbSet<GraveEmergencyContact> GraveEmergencyContacts => Set<GraveEmergencyContact>();
