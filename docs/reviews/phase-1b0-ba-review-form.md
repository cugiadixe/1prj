# Biểu mẫu Đánh giá Phase 1B.0 — BA / Product Owner

## 1. Mục đích tài liệu (Document purpose)
Thu thập các phê duyệt chính thức từ **BA / Product Owner** đối với các thiết kế bảo mật và kiến trúc của Phase 1B.0.
...
## 3. Vai trò người phê duyệt (Reviewer role): BA / Product Owner
...
- **Câu hỏi phê duyệt chính xác (Exact approval question):** Mô hình tách biệt tài khoản đăng nhập (User_Auth_Accounts) khỏi thông tin nhân sự (Users) có phù hợp với chính sách tổ chức không?
...
- **Điều kiện phê duyệt bắt buộc (Mandatory approval conditions):** None documented beyond compatible approval from all required approvers.
- **Câu hỏi phê duyệt chính xác (Exact approval question):** Các ràng buộc chính sách mật khẩu (min 8, max 64, lịch sử 5, tạm thời 24h) có phù hợp trải nghiệm người dùng và chính sách nội bộ không?
- **Phản hồi của người đánh giá (Reviewer response):**
  [ CHỌN MỘT: APPROVED | APPROVED WITH CONDITIONS | REJECTED | DEFERRED — NON-BLOCKING | REMAIN OPEN ]
- **Điều kiện của người đánh giá (Reviewer conditions):**
- **Nhận xét của người đánh giá (Reviewer comments):**
...
- **Điều kiện phê duyệt bắt buộc (Mandatory approval conditions):** None documented beyond compatible approval from all required approvers.
- **Câu hỏi phê duyệt chính xác (Exact approval question):** Access token 15 phút và Refresh token 7 ngày có cân bằng được trải nghiệm người dùng và bảo mật không?
- **Phản hồi của người đánh giá (Reviewer response):**
  [ CHỌN MỘT: APPROVED | APPROVED WITH CONDITIONS | REJECTED | DEFERRED — NON-BLOCKING | REMAIN OPEN ]
- **Điều kiện của người đánh giá (Reviewer conditions):**
- **Nhận xét của người đánh giá (Reviewer comments):**
...
- **Điều kiện phê duyệt bắt buộc (Mandatory approval conditions):** None documented beyond compatible approval from all required approvers.
- **Câu hỏi phê duyệt chính xác (Exact approval question):** Chính sách khóa tài khoản 15 phút sau 5 lần đăng nhập sai có phù hợp với quy trình nghiệp vụ không?
- **Phản hồi của người đánh giá (Reviewer response):**
  [ CHỌN MỘT: APPROVED | APPROVED WITH CONDITIONS | REJECTED | DEFERRED — NON-BLOCKING | REMAIN OPEN ]
- **Điều kiện của người đánh giá (Reviewer conditions):**
- **Nhận xét của người đánh giá (Reviewer comments):**
...
- **Điều kiện phê duyệt bắt buộc (Mandatory approval conditions):** None documented beyond compatible approval from all required approvers.
- **Câu hỏi phê duyệt chính xác (Exact approval question):** Việc người dùng bị đăng xuất toàn bộ phiên (revoke family) khi phát hiện token bị tái sử dụng có được chấp nhận không?
- **Phản hồi của người đánh giá (Reviewer response):**
  [ CHỌN MỘT: APPROVED | APPROVED WITH CONDITIONS | REJECTED | DEFERRED — NON-BLOCKING | REMAIN OPEN ]
- **Điều kiện của người đánh giá (Reviewer conditions):**
- **Nhận xét của người đánh giá (Reviewer comments):**
...
- **Câu hỏi phê duyệt chính xác (Exact approval question):** Các mã quyền (permission codes) dạng chuỗi cố định, không thể đổi tên sau release, có được chấp nhận không?
- **Phản hồi của người đánh giá (Reviewer response):**
  [ CHỌN MỘT: APPROVED | APPROVED WITH CONDITIONS | REJECTED | DEFERRED — NON-BLOCKING | REMAIN OPEN ]
- **Điều kiện của người đánh giá (Reviewer conditions):**
- **Nhận xét của người đánh giá (Reviewer comments):**
...
- **Câu hỏi phê duyệt chính xác (Exact approval question):** Phase 1B chỉ hỗ trợ phạm vi GLOBAL và COMPANY? Phạm vi ENTITY có bị loại trừ khỏi Phase 1B không? Mã role_code và group_code cố định có bắt buộc không?
- **Phản hồi của người đánh giá (Reviewer response):**
  [ CHỌN MỘT: APPROVED | APPROVED WITH CONDITIONS | REJECTED | DEFERRED — NON-BLOCKING | REMAIN OPEN ]
- **Điều kiện của người đánh giá (Reviewer conditions):**
- **Nhận xét của người đánh giá (Reviewer comments):**
...
- **Điều kiện phê duyệt bắt buộc (Mandatory approval conditions):** None documented beyond compatible approval from all required approvers.
- **Câu hỏi phê duyệt chính xác (Exact approval question):** Mô hình Admin Group (nhóm quản trị viên gộp nhiều Roles) có phù hợp với quy trình phân quyền của tổ chức không?
- **Phản hồi của người đánh giá (Reviewer response):**
  [ CHỌN MỘT: APPROVED | APPROVED WITH CONDITIONS | REJECTED | DEFERRED — NON-BLOCKING | REMAIN OPEN ]
- **Điều kiện của người đánh giá (Reviewer conditions):**
- **Nhận xét của người đánh giá (Reviewer comments):**
...
- **Điều kiện phê duyệt bắt buộc (Mandatory approval conditions):** None documented beyond compatible approval from all required approvers.
- **Câu hỏi phê duyệt chính xác (Exact approval question):** Không có giao diện UI để tạo admin đầu tiên (bootstrap qua CLI) có được chấp nhận không?
- **Phản hồi của người đánh giá (Reviewer response):**
  [ CHỌN MỘT: APPROVED | APPROVED WITH CONDITIONS | REJECTED | DEFERRED — NON-BLOCKING | REMAIN OPEN ]
- **Điều kiện của người đánh giá (Reviewer conditions):**
- **Nhận xét của người đánh giá (Reviewer comments):**
...
- **Điều kiện phê duyệt bắt buộc (Mandatory approval conditions):** None documented beyond compatible approval from all required approvers.
- **Câu hỏi phê duyệt chính xác (Exact approval question):** Hành vi Fail-closed (từ chối truy cập khi cache phân quyền lỗi, thay vì rò rỉ dữ liệu) có được chấp nhận không?
- **Phản hồi của người đánh giá (Reviewer response):**
  [ CHỌN MỘT: APPROVED | APPROVED WITH CONDITIONS | REJECTED | DEFERRED — NON-BLOCKING | REMAIN OPEN ]
- **Điều kiện của người đánh giá (Reviewer conditions):**
- **Nhận xét của người đánh giá (Reviewer comments):**
...
- **Câu hỏi phê duyệt chính xác (Exact approval question):** Bắt buộc X-Company-Id cho mọi endpoint COMPANY và cấm fallback về công ty chính cho thao tác ghi dữ liệu có đúng nghiệp vụ không?
- **Phản hồi của người đánh giá (Reviewer response):**
  [ CHỌN MỘT: APPROVED | APPROVED WITH CONDITIONS | REJECTED | DEFERRED — NON-BLOCKING | REMAIN OPEN ]
- **Điều kiện của người đánh giá (Reviewer conditions):**
- **Nhận xét của người đánh giá (Reviewer comments):**
...
- **Điều kiện phê duyệt bắt buộc (Mandatory approval conditions):** None documented beyond compatible approval from all required approvers.
- **Câu hỏi phê duyệt chính xác (Exact approval question):** Chỉ có trạng thái nhân sự ACTIVE và PROBATION mới được phép đăng nhập hệ thống đúng không?
- **Phản hồi của người đánh giá (Reviewer response):**
  [ CHỌN MỘT: APPROVED | APPROVED WITH CONDITIONS | REJECTED | DEFERRED — NON-BLOCKING | REMAIN OPEN ]
- **Điều kiện của người đánh giá (Reviewer conditions):**
- **Nhận xét của người đánh giá (Reviewer comments):**
...
- **Câu hỏi phê duyệt chính xác (Exact approval question):** Hành vi từ chối phân quyền chồng chéo thời gian (temporal overlap) có phù hợp nghiệp vụ không?
- **Phản hồi của người đánh giá (Reviewer response):**
  [ CHỌN MỘT: APPROVED | APPROVED WITH CONDITIONS | REJECTED | DEFERRED — NON-BLOCKING | REMAIN OPEN ]
- **Điều kiện của người đánh giá (Reviewer conditions):**
- **Nhận xét của người đánh giá (Reviewer comments):**
...
- **Câu hỏi phê duyệt chính xác (Exact approval question):** Các trường được log trong Security Audit có đáp ứng nhu cầu truy vết nghiệp vụ không? Những hành động nào bắt buộc phải có lý do (reason)?
- **Phản hồi của người đánh giá (Reviewer response):**
  [ CHỌN MỘT: APPROVED | APPROVED WITH CONDITIONS | REJECTED | DEFERRED — NON-BLOCKING | REMAIN OPEN ]
- **Điều kiện của người đánh giá (Reviewer conditions):**
- **Nhận xét của người đánh giá (Reviewer comments):**
...
- **Điều kiện phê duyệt bắt buộc (Mandatory approval conditions):** None documented beyond compatible approval from all required approvers.
- **Câu hỏi phê duyệt chính xác (Exact approval question):** Toàn bộ các mã quyền ORGANIZATION_* và SECURITY_* được đề xuất có được chấp nhận không?
- **Phản hồi của người đánh giá (Reviewer response):**
  [ CHỌN MỘT: APPROVED | APPROVED WITH CONDITIONS | REJECTED | DEFERRED — NON-BLOCKING | REMAIN OPEN ]
- **Điều kiện của người đánh giá (Reviewer conditions):**
- **Nhận xét của người đánh giá (Reviewer comments):**
...
- **Câu hỏi phê duyệt chính xác (Exact approval question):** Việc hoãn tính năng Archive/Purge sang giai đoạn sau (không xây trong Phase 1B) có được chấp nhận không?
- **Phản hồi của người đánh giá (Reviewer response):**
  [ CHỌN MỘT: APPROVED | APPROVED WITH CONDITIONS | REJECTED | DEFERRED — NON-BLOCKING | REMAIN OPEN ]
- **Điều kiện của người đánh giá (Reviewer conditions):**
- **Nhận xét của người đánh giá (Reviewer comments):**
...
- **Câu hỏi phê duyệt chính xác (Exact approval question):** Luồng đăng nhập qua Cookie (access token in memory, refresh token in HttpOnly cookie) có ảnh hưởng trải nghiệm ứng dụng SPA không?
- **Phản hồi của người đánh giá (Reviewer response):**
  [ CHỌN MỘT: APPROVED | APPROVED WITH CONDITIONS | REJECTED | DEFERRED — NON-BLOCKING | REMAIN OPEN ]
- **Điều kiện của người đánh giá (Reviewer conditions):**
- **Nhận xét của người đánh giá (Reviewer comments):**
...
- **Câu hỏi phê duyệt chính xác (Exact approval question):** Việc sử dụng secret provider bên ngoài (không hardcode key) cho môi trường Production có phù hợp hạ tầng tổ chức không?
- **Phản hồi của người đánh giá (Reviewer response):**
  [ CHỌN MỘT: APPROVED | APPROVED WITH CONDITIONS | REJECTED | DEFERRED — NON-BLOCKING | REMAIN OPEN ]
- **Điều kiện của người đánh giá (Reviewer conditions):**
- **Nhận xét của người đánh giá (Reviewer comments):**
...
- **Câu hỏi phê duyệt chính xác (Exact approval question):** Việc trả mã trạng thái riêng (403 hoặc 423) khi tài khoản bị khóa có phù hợp với chính sách thông báo cho người dùng không?
- **Phản hồi của người đánh giá (Reviewer response):**
  [ CHỌN MỘT: APPROVED | APPROVED WITH CONDITIONS | REJECTED | DEFERRED — NON-BLOCKING | REMAIN OPEN ]
- **Điều kiện của người đánh giá (Reviewer conditions):**
- **Nhận xét của người đánh giá (Reviewer comments):**
...
- **Câu hỏi phê duyệt chính xác (Exact approval question):** Quyền AUDIT_VIEW hiện có trong permission-catalog.md nên được tái sử dụng cho security audit, hay cần tạo SECURITY_AUDIT_VIEW riêng biệt?
- **Phản hồi của người đánh giá (Reviewer response):**
  [ CHỌN MỘT: APPROVED | APPROVED WITH CONDITIONS | REJECTED | DEFERRED — NON-BLOCKING | REMAIN OPEN ]
- **Điều kiện của người đánh giá (Reviewer conditions):**
- **Nhận xét của người đánh giá (Reviewer comments):**
...
- **DEC-1B-001:** Mô hình tách biệt tài khoản đăng nhập (User_Auth_Accounts) khỏi thông tin nhân sự (Users) có phù hợp với chính sách tổ chức không?
- **DEC-1B-002:** Các ràng buộc chính sách mật khẩu (min 8, max 64, lịch sử 5, tạm thời 24h) có phù hợp trải nghiệm người dùng và chính sách nội bộ không?
- **DEC-1B-003:** Access token 15 phút và Refresh token 7 ngày có cân bằng được trải nghiệm người dùng và bảo mật không?
- **DEC-1B-004:** Chính sách khóa tài khoản 15 phút sau 5 lần đăng nhập sai có phù hợp với quy trình nghiệp vụ không?
- **DEC-1B-005:** Việc người dùng bị đăng xuất toàn bộ phiên (revoke family) khi phát hiện token bị tái sử dụng có được chấp nhận không?
- **DEC-1B-006:** Các mã quyền (permission codes) dạng chuỗi cố định, không thể đổi tên sau release, có được chấp nhận không?
- **DEC-1B-007:** Phase 1B chỉ hỗ trợ phạm vi GLOBAL và COMPANY? Phạm vi ENTITY có bị loại trừ khỏi Phase 1B không? Mã role_code và group_code cố định có bắt buộc không?
- **DEC-1B-009:** Mô hình Admin Group (nhóm quản trị viên gộp nhiều Roles) có phù hợp với quy trình phân quyền của tổ chức không?
- **DEC-1B-010:** Không có giao diện UI để tạo admin đầu tiên (bootstrap qua CLI) có được chấp nhận không?
- **DEC-1B-011:** Hành vi Fail-closed (từ chối truy cập khi cache phân quyền lỗi, thay vì rò rỉ dữ liệu) có được chấp nhận không?
- **DEC-1B-012:** Bắt buộc X-Company-Id cho mọi endpoint COMPANY và cấm fallback về công ty chính cho thao tác ghi dữ liệu có đúng nghiệp vụ không?
- **DEC-1B-013:** Chỉ có trạng thái nhân sự ACTIVE và PROBATION mới được phép đăng nhập hệ thống đúng không?
- **DEC-1B-014:** Hành vi từ chối phân quyền chồng chéo thời gian (temporal overlap) có phù hợp nghiệp vụ không?
- **DEC-1B-015:** Các trường được log trong Security Audit có đáp ứng nhu cầu truy vết nghiệp vụ không? Những hành động nào bắt buộc phải có lý do (reason)?
- **DEC-1B-016:** Toàn bộ các mã quyền ORGANIZATION_* và SECURITY_* được đề xuất có được chấp nhận không?
- **DEC-1B-017:** Việc hoãn tính năng Archive/Purge sang giai đoạn sau (không xây trong Phase 1B) có được chấp nhận không?
- **DEC-1B-018:** Luồng đăng nhập qua Cookie (access token in memory, refresh token in HttpOnly cookie) có ảnh hưởng trải nghiệm ứng dụng SPA không?
- **DEC-1B-019:** Việc sử dụng secret provider bên ngoài (không hardcode key) cho môi trường Production có phù hợp hạ tầng tổ chức không?
- **DEC-1B-020:** Việc trả mã trạng thái riêng (403 hoặc 423) khi tài khoản bị khóa có phù hợp với chính sách thông báo cho người dùng không?
- **DEC-1B-021:** Quyền AUDIT_VIEW hiện có trong permission-catalog.md nên được tái sử dụng cho security audit, hay cần tạo SECURITY_AUDIT_VIEW riêng biệt?
